<x-dashboard-layout title="{{ __('lang.asset_type') }}" subTitle="{{ __('lang.index') }}">
    <!--begin:::Tab content-->
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Filter-->
                        <a href="{{ route('asset_type.create') }}" class="btn btn-sm btn-flex btn-light-primary">
                ...
                <div class="card-body pt-0 pb-5 tableData">
                    @include('dashboard.asset_type.table')
                </div>
                <!--end::Card body-->
            </div>
            <!--end::Card-->
            ...
            $(document).on('click', '.deleteBtn', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#deleteAssetType-'+id).modal('hide');

                        $.ajax({
                            url: "{{ route('asset_type.index') }}"
                        }).done(function(data) {
                            $('.tableData').html(data);
                        })
                        Swal.fire({
