<x-dashboard-layout title="{{ __('lang.subdivision') }}" subTitle="{{ __('lang.index') }}">
    <!--begin:::Tab content-->
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Filter-->
                        <a href="{{ route('subdivision.create') }}" class="btn btn-sm btn-flex btn-light-primary">
                ...
                <div class="card-body pt-0 pb-5 tableData">
                    @include('dashboard.subdivision.table')
                </div>
                <!--end::Card body-->
            </div>
            <!--end::Card-->
            ...
            $(document).on('click', '.deleteBtn', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#deleteSubdivision-'+id).modal('hide');

                        $.ajax({
                            url: "{{ route('subdivision.index') }}"
                        }).done(function(data) {
                            $('.tableData').html(data);
                        })
                        Swal.fire({
