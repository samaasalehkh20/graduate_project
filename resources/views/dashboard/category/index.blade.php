<x-dashboard-layout title="{{ __('lang.category') }}" subTitle="{{ __('lang.index') }}">
    <!--begin:::Tab content-->
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Filter-->
                        <a href="{{ route('category.create') }}" class="btn btn-sm btn-flex btn-light-primary">
