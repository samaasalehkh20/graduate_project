<x-dashboard-layout title="{{ __('lang.measurement_unit') }}" subTitle="{{ __('lang.index') }}">
    <!--begin:::Tab content-->
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Filter-->
                        <a href="{{ route('measurement_unit.create') }}" class="btn btn-sm btn-flex btn-light-primary">
                ...
                <div class="card-body pt-0 pb-5 tableData">
                    @include('dashboard.measurement_unit.table')
                </div>
                <!--end::Card body-->
            </div>
            <!--end::Card-->
    ...
    @section('js')
        <script>
            $(document).on('click', '.deleteBtn', function(e) {
                ...
                $.ajax({
                    url: "{{ route('measurement_unit.delete') }}",
                    type: "DELETE",
                    data: {
                        id: id,
                    },
                    success: function(data) {
                        ...
                        $.ajax({
                            url: "{{ route('measurement_unit.index') }}"
                        }).done(function(data) {
                            $('.tableData').html(data);
                        })
                        ...
                        $('#deleteMeasurementUnit-'+id).modal('hide');
