<x-dashboard-layout title="{{ __('lang.asset_location') }}" subTitle="{{ __('lang.index') }}">
    <!--begin:::Tab content-->
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Filter-->
                        <a href="{{ route('asset_location.create') }}" class="btn btn-sm btn-flex btn-light-primary">
                ...
                <div class="card-body pt-0 pb-5 tableData">
                    @include('dashboard.asset_location.table')
                </div>
                <!--end::Card body-->
            </div>
            <!--end::Card-->
    ...
    @section('js')
        <script>
            $(document).on('click', '.deleteBtn', function(e) {
                ...
                $.ajax({
                    url: "{{ route('asset_location.delete') }}",
                    type: "DELETE",
                    data: {
                        id: id,
                    },
                    success: function(data) {
                        ...
                        $.ajax({
                            url: "{{ route('asset_location.index') }}"
                        }).done(function(data) {
                            $('.tableData').html(data);
                        })
                        Swal.fire({
                        ...
                        $('#deleteAssetLocation-'+id).modal('hide');
                    },
                    error: function(data) {
